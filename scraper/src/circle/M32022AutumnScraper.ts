...
export default class M32022SpringScraper extends AbstractScraper {
    static LIST_URL: string = 'http://www.m3net.jp/attendance/circle2022aR.php'
    ...
    static PERIOD: [Date, Date] = [new Date('2022-10-01 00:00:00'), new Date('2022-10-31 23:59:59')]
    static ID: string = 'm3-2022-autumn'
    ...
    async fetch(): Promise<Circle[]> {
        try {
            const response = await axios.get(M32022SpringScraper.LIST_URL)
