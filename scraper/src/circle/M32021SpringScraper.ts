...
export class M32021SpringScraper extends AbstractScraper {
    static LIST_URL: string = 'http://www.m3net.jp/attendance/circle2021sR.php'
    ...
    async fetch(): Promise<Circle[]> {
        try {
            const response = await axios.get(M32021SpringScraper.LIST_URL)
