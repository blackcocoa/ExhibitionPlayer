...
export default class M32022SpringScraper extends AbstractScraper {
    static LIST_URL: string = 'http://www.m3net.jp/attendance/circle2022sR.php'
    ...
    static PERIOD: [Date, Date] = [new Date('2022-4-01 00:00:00'), new Date('2022-4-24 23:59:59')]
    static ID: string = 'm3-2022-spring'
